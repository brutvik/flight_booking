...
if(isset($_REQUEST['fname'])){
  ...
  else if($_REQUEST['fname'] == "signing")
  {
      ...
      else
      {
        ...
        $textlocal = new Textlocal(false,false, 'SZgxlQ3rZdw-1u5OiNAUgXaLZrDIuC0Zipe9q4L6Hx');
        ...
        try {
              $textlocal->sendSms($number, $message, $sender);
        } catch (Exception $e) {
...
<body class="login">
	<div class="container">
		<div class="login-container-wrapper clearfix">
            ...
            <div class="form-group relative">
							<input class="form-control input-lg" id="login_phonenumber" placeholder="phonenumber" name = "pno" required="" type="text"> <i class="fa fa-user"></i>
						</div>
						<div class="form-group relative">
